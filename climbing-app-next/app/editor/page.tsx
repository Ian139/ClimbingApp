...
import { HoldType, Route, V_GRADES, HOLD_COLORS } from '@/lib/types';
...
export default function EditorPage() {
  ...
  return (
    <div className="h-dvh bg-zinc-950 flex flex-col overflow-hidden">
      ...
      <header className="absolute top-0 left-0 right-0 z-50 px-4 pt-4 pb-2">
        <div className="flex items-center justify-between">
          <Link
            ...
            className="size-10 rounded-xl bg-zinc-900/80 backdrop-blur-md border border-zinc-800 flex items-center justify-center text-zinc-300 hover:text-white hover:bg-zinc-800 transition-colors"
          >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={!canUndo}
              aria-label="Undo"
              className="size-10 rounded-xl bg-zinc-900/80 backdrop-blur-md border border-zinc-800 flex items-center justify-center text-zinc-300 hover:text-white hover:bg-zinc-800 transition-colors disabled:opacity-30 disabled:hover:bg-zinc-900/80"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-50 p-4 pb-safe">
        {/* Hold count badge */}
